...
class CustomWarmTransferTask(AgentTask[WarmTransferResult]):
    def __init__(
        self,
        ...
        *,
        ...
        self._sip_number = str(self._sip_number)
    ...
    async def _dial_human_agent(self) -> AgentSession:
        ...
        await job_ctx.api.sip.create_sip_participant(
            api.CreateSIPParticipantRequest(
                ...
                participant_identity=self._human_agent_identity,
                wait_until_answered=False, # FIXED: set to False to bypass 403 Forbidden
